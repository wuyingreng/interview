...
import { HOC, Child, ClassHOC, ClassChild } from '../components/HOC/Child';
import { TestUseEffect } from '../components/hooks/useEffect';

import { UseRef } from '../components/hooks/UseRef';
import { UseRefVariable } from '../components/hooks/useRefVariable';
import { ContextProviderCom } from '../components/hooks/useContext';
import { UseMemoComp } from '../components/hooks/useMemo';
...
export function Welcome() {
  ...
  const ClassHOCChild = ClassHOC(ClassChild);
  ...
  return (
    <main className="items-center justify-center pt-16 pb-4">
     ...
     <TestUseEffect/>
      ...
      <div>
        <div>{count}</div>
          <button onClick={()=>setCount(count+1)}>增加count按钮</button>
      </div> */}
      {/*<ErroryBoundary >
        <ErroryBoundaryChild />
      </ErroryBoundary>*/}
